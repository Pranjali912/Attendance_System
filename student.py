...
class Student:
    def __init__(self,root):
       ...
       # img_left = Image.open(r"C:\Users\pc\Documents\web development\face recognition\images\image3.jpg")
       ...
       # f_lbl.place(x=5,y=0,width=650,height=130)
        ...
        current_course_frame.place(x=5,y=5,width=650,height=130)
          # Depatment
        ...
        course_combo["values"]=("select course","FE","BE","BTECH","BCA")
        ...
        class_student_frame.place(x=5,y=140,width=650,height=300)
        #student id
        ...
        studentname_entry=ttk.Entry(class_student_frame,textvariable=self.var_std,width=20,font =("times new roman",12,"bold"))
        ...
        roll_label= Label(class_student_frame,text="Roll number",font =("times new roman",12,"bold"))
        ...
        btn_frame1.place(x=0,y=240,width=715,height=40)
       ...
       # table frame
        ...
        table_frame.place(x=5,y=80,width=650,height=390)

        scroll_x= ttk.Scrollbar(table_frame,orient=HORIZONTAL)
        scroll_y= ttk.Scrollbar(table_frame,orient=VERTICAL)

        self.student_table=ttk.Treeview(table_frame,columns=("dep","course","year","sem","id","name","div","email","roll","gender","phone","address","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
    ...
    def add_data(self):
      if self.var_dep.get()=="Select Department" or self.var_std.get()=="" or self.var_std_id.get()=="":
    ...
    # -------fetch data------
    def fetch_data(self):
      conn= mysql.connector.connect(host="localhost",username="root",password="#rahulranjan1",database="face_recognition")
      my_cursor=conn.cursor()
